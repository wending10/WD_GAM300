...
namespace TDS 
{
	...
	****************************************************************************/
	int ImguiInput(std::string variableName, int intVariable, float speed = 1.f, int min = 0, int max = 0);
	/*!*************************************************************************
	This function is a helper function for draw FLOAT variables
	****************************************************************************/
	float ImguiInput(std::string variableName, float floatVariable, float speed = 1.f, float min = 0, float max = 0);
	/*!*************************************************************************
