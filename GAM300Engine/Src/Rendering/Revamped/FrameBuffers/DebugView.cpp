#include "Rendering/Revamped/FrameBuffers/DebugView.h"
#include "Rendering/GraphicsManager.h"
#include "vulkanTools/VulkanPipeline.h"
namespace TDS
{
	DebugView::DebugView(Vec2 DimensionInput)
	{
		m_Resizeable = true;
		m_AutoSync = true;
	...
	bool DebugView::Resize(std::uint32_t width, std::uint32_t height)
	{
	...
	void DebugView::GetBlendAttachments(BlendContainer& blendCont, PipelineCreateEntry& createEntry)
	{
		blendCont.resize(1);
