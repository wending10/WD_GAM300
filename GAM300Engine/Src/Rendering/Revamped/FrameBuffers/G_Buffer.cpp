...
namespace TDS
{
	G_Buffer::G_Buffer(Vec2 DimensionInput)
	{
		m_Resizeable = true;
		m_AutoSync = true;
	...
	bool G_Buffer::Resize(std::uint32_t width, std::uint32_t height)
	{
	...
	void G_Buffer::GetBlendAttachments(BlendContainer& blendCont, PipelineCreateEntry& createEntry)
	{
		...
		blendCont[2].colorWriteMask = VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT | VK_COLOR_COMPONENT_B_BIT | VK_COLOR_COMPONENT_A_BIT;
		blendCont[2].blendEnable = VK_FALSE;
		blendCont[2].srcColorBlendFactor = createEntry.m_PipelineConfig.m_SrcClrBlend;
		blendCont[2].dstColorBlendFactor = createEntry.m_PipelineConfig.m_DstClrBlend;
		blendCont[2].colorBlendOp = createEntry.m_PipelineConfig.m_ColorBlend;
		blendCont[2].srcAlphaBlendFactor = createEntry.m_PipelineConfig.m_SrcAlphaBlend;
		blendCont[2].dstAlphaBlendFactor = createEntry.m_PipelineConfig.m_DstAlphaBlend;
		blendCont[2].alphaBlendOp = createEntry.m_PipelineConfig.m_AlphaBlend;

		blendCont[3].colorWriteMask = VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT | VK_COLOR_COMPONENT_B_BIT | VK_COLOR_COMPONENT_A_BIT;
		blendCont[3].blendEnable = VK_FALSE;
		blendCont[3].srcColorBlendFactor = createEntry.m_PipelineConfig.m_SrcClrBlend;
		blendCont[3].dstColorBlendFactor = createEntry.m_PipelineConfig.m_DstClrBlend;
		blendCont[3].colorBlendOp = createEntry.m_PipelineConfig.m_ColorBlend;
